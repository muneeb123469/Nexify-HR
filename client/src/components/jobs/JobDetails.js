    ...
    <Container>
      ...
      >
        ...
        <ButtonGroup>
          ...
          {hasRole('hr') && (
            <>
              <Button className="primary" onClick={handleEdit}>Edit Job</Button>
              <Button className="secondary" onClick={handleStatusChange}>
                {job.status === 'open' ? 'Close Job' : 'Reopen Job'}
              </Button>
              <Button className="danger" onClick={handleDelete}>Delete Job</Button>
            </>
          )}
          
          {/* Applicant-only button */}
          {hasRole('applicant') && job.status === 'open' && (
            <Button className="primary" onClick={handleApply}>Apply Now</Button>
          )}
