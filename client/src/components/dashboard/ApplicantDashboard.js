      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center">
          ...
          <div className="ml-4 flex items-center">
            ...
            <span className="text-sm font-medium text-[#4C9F9F]">
      ...
      <div className="bg-white rounded-lg p-4 sm:p-6 w-full max-w-[600px] max-h-[80vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          <div className="border-t border-gray-200 pt-4">
            <h4 className="text-sm font-medium text-[#2C3E50] mb-2">
              Application Details
            </h4>
                  ...
                  <div className="flex items-start">
                    <div className="flex-shrink-0">
                      {notification.type === "application" && (
                        <FileText className="w-5 h-5 text-[#4C9F9F]" />
                      )}
                      {notification.type === "interview" && (
                        <Calendar className="w-5 h-5 text-[#4C9F9F]" />
                      )}
                      {notification.type === "offer" && (
                        <CheckCircle2 className="w-5 h-5 text-[#4C9F9F]" />
                      )}
                    </div>
                    <div className="ml-3">
                      <p className="text-sm font-medium text-[#2C3E50]">
    ...
    <div className="applicant-dashboard">
      ...
      <main className="dashboard-main">
        <div className="dashboard-header">
          <h1>Welcome, {user?.username || user?.name || "Applicant"}</h1>
          <p>Manage your job applications, interviews, and profile.</p>
        </div>
